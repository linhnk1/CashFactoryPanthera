...
- Download CashFactoryPanthera latest release in $HOME directory : cd $HOME, then : wget https://github.com/linhnk1/CashFactoryPanthera/archive/refs/tags/v1.0.4.tar.gz , then uncompress : tar -xvf v1.0.4.tar.gz
- Edit created directory name to CashFactoryPanthera and cd inside : mv CashFactoryPanthera-1.0.4 CashFactoryPanthera ; cd CashFactoryPanthera
